    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(req -> req
                ...
                // Incluye Productos, Servicios, Veterinarios y Turnos (para agendar cita)
                ...
                // Historial (PUT para Atender/Finalizar)
                .requestMatchers(HttpMethod.PUT, "/api/v1/medical-history/**").hasAuthority("ROLE_ADMIN")
                
                // GESTIÓN COMPLETA (CREATE/UPDATE/DELETE) para productos, servicios, turnos y proveedores
                .requestMatchers("/api/v1/products/**").hasAuthority("ROLE_ADMIN") // Permisos de modificación para Productos
